...
---
## Wrapping up
This step is the most complex, the code illustrate a more advanced use of prompting to capture many user inputs in a single step.
Next, we will examine how to present the found hotel to a user.
